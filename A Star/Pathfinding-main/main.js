...
function selectAStarAlgorithm() {
    // Get the select element
    var selectElement = document.getElementById("algo-select");

    // Set the value of the select element to "AStar"
    selectElement.value = "AStar";
}
